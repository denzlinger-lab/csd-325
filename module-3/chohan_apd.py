...
RULE ADDITION
If the player rolls a 2 or a 7, they get a 10 mon bonus.
''')
...
while True:  # Main game loop.
    ...
    # added to facilitate the 2 or 7 bonus
    ...
    if playerWon:
        ...
        # changed fee from 10 percent to 12 percent
        print('The house collects a', pot * .12, 'mon fee.')
        # changed fee from 10 percent to 12 percent
        purse = purse - (pot - (pot * .12))  # The house fee is now 12%.
    else:
        purse = purse - pot  # Subtract the pot from player's purse.
        print('You lost!')

    # Add bonus for 2 or 7
    # Print 2 or 7 bonus results
